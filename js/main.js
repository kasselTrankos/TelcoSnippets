...
{
    $scope.gotCamera = (typeof window.orientation !== 'undefined');
   // var cams = window.webcam.getCameraList()|| FALSE;
...
solApp.controller('solicitudAltaCtrl',['$scope', '$element',function ($scope, $element)
{
   ...
   ///////////////////////////////////
   ////fill data
   $scope.name = (typeof(_solicitud_data_name)=="undefined")? "" : _solicitud_data_name;
   $scope.appel = (typeof(_solicitud_data_appel1)=="undefined")?"":_solicitud_data_appel1;
   $scope.sex = (typeof(_solicitud_data_sex)=="undefined")?"":_solicitud_data_sex;
   $scope.dni = (typeof(_solicitud_data_dni)=="undefined")?"":_solicitud_data_dni;
   ///born
  var now = moment();

   $scope.day = (typeof(_solicitud_data_day)=="undefined")?"": parseInt(_solicitud_data_day);
   $scope.month = (typeof(_solicitud_data_month)=="undefined")? "": parseInt(_solicitud_data_month);
   $scope.year = (typeof(_solicitud_data_year)=="undefined")? "" : _solicitud_data_year;
   ...
   ///a la carga
   $scope.tlf = (typeof(_solicitud_data_tlf)=="undefined")? "" : _solicitud_data_tlf;
   $scope.twitter = (typeof(_solicitud_data_twitter)=="undefined")? "" : _solicitud_data_twitter;
   $scope.tipoVia = (typeof(_solicitud_data_tipoVia)=="undefined")? "" :_solicitud_data_tipoVia;
   $scope.nameVia = (typeof(_solicitud_data_nameVia)=="undefined")? "" :_solicitud_data_nameVia;
   $scope.numVia = (typeof(_solicitud_data_numVia)=="undefined")? "" :_solicitud_data_numVia;

   $scope.dir = (typeof(_solicitud_data_dir)=="undefined")? "" : _solicitud_data_dir;
   $scope.provincia = (typeof(_solicitud_data_provincia)=="undefined")? "" : _solicitud_data_provincia;
   $scope.localidad = (typeof(_solicitud_data_localidad)=="undefined")? "": _solicitud_data_localidad;
   $scope.cp = (typeof(_solicitud_data_cp)=="undefined")?"":_solicitud_data_cp;


   $scope.pwd = (typeof(_solicitud_data_pwd)=="undefined")?"":_solicitud_data_pwd;
   $scope.email = (typeof(_solicitud_data_email)=="undefined")? "" : _solicitud_data_email;
   ///////ERRORS
   $scope.$watch('altaall', function(theForm) {

       if(typeof(_solicitud_err_name)!='undefined')
       {

           $scope.altaall['altaall[name]'].$setTouched();
           $scope.altaall['altaall[name]'].$setDirty();
       }
       if(typeof(_solicitud_err_appel1)!='undefined'){
           $scope.altaall['altaall[appel1]'].$setTouched();
           $scope.altaall['altaall[appel1]'].$setDirty();
       }
       if(typeof(_solicitud_err_sex)!='undefined')
       {

           $scope.altaall['altaall[sex]'].$setTouched();
           $scope.altaall['altaall[sex]'].$setDirty();
       }
       if(typeof(_solicitud_err_dni)!='undefined'){
           $scope.altaall['altaall[dni]'].$setTouched();
           $scope.altaall['altaall[dni]'].$setDirty();
       }
       if(typeof(_solicitud_err_born)!='undefined')
       {
       ...
       if(typeof(_solicitud_err_email)!='undefined')
       {
           $scope.altaall['altaall[email]'].$setTouched();
           $scope.altaall['altaall[email]'].$setDirty();
       }
       if(typeof(_solicitud_err_pwd)!='undefined')
       {
